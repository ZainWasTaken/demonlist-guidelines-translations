...
На этой странице хранятся различные изменения, внесенные Командой в правила и гайдлайны Демонлиста. На данный момент наша единственная система уведомлений о новых изменениях находится на нашем [Discord сервере](https://discord.gg/M7bDDQf), поэтому, если вы не являетесь там участником, рекомендуется время от времени проверять этот раздел на наличие новых обновлений.

Перечисленные здесь изменения упорядочены от самых последних до самых первых. **Текущая версия: v2.0**

## Изменения с версии 1.8 на 2.0 (17.07.2022)

- Изменены формулировки почти всех гайдлайнов на этом сайте - прошло много времени!
- Добавлено **абсолютное требование** для слышимых кликов, необработанной записи и счетчика FPS.

- Изменены [гайдлайны для необработанных записей](/guidelines/rawfootage#requiredraw), теперь требуется **ссылка на Google Диск** вместо видео на YouTube.
- Добавлены новые гайдлайны, связанные с [Личным Кабинетом](/login) и постоянным [LDM-Проектом](https://discord.gg/Ua8M4YJTBw).
- Обновлены примеры багов и скипов на уровнях, которых больше нет в листе.
- Обновлен список [разрешенных хаков](/guidelines/miscellaneous#allowed-hacks) в соответствии с последней версией Мегахака.
- Обновлены [Ключевые Выводы](/guidelines/index#takeaways) и [Чеклист для Игроков](/guidelines/miscellaneous#checklist) в соответствии с вышеописанными изменениями.
